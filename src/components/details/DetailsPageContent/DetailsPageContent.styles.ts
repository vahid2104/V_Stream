export const detailsPageStyles = {
  ...
  overlayTop:
    "absolute inset-0 bg-gradient-to-b from-black/90 via-black/35 to-transparent",
  overlaySide:
    "absolute inset-0 bg-gradient-to-r from-black via-black/65 to-black/25",
  overlayBottom:
    "absolute inset-0 bg-gradient-to-t from-[#06070d] via-[#06070d]/80 to-transparent",
  ...
  castAvatar: "relative h-12 w-12 shrink-0 overflow-hidden rounded-full bg-white/5",
